 ...
 *
 * Review decisions, app suspension and the Partner-apps kill switch need the
 * 2FA step-up; listing flags do not. Everything is written to audit_logs.
 */

import { apiClient } from "./api";

export type AppChangeType = "new_app" | "new_scopes" | "urls" | "listing_only";
